...
(function() {
<<<<<<< HEAD
  var EOL, FILE_ENCODING, build_dir, changeDir, checkConfiguration, cleanUpDir, cleanUpDirWorker, coffee, coffeeSources, colors, compileAssets, compileCoffee, compileCoffeeDir, compileLess, compileLessDir, compiledAssets, configuration, copyLavaFiles, copyPluginFiles, copyToTestServer, createTmpDir, downQueue, exists, fs, fse, getAbsDir, getCoffeeFiles, less, logging, namespaceClasses, namespaceClassesWorker, path, program, queue, upQueue, wrench, yaml, _allowed_extensions, _other_extensions,
...
=======
  ...
  program.version('1.0.0').option('-d, --distribute', 'Build distribution version').parse(process.argv);

  if (program.distribute(console.log('Building distribution copy'))) {

  } else {
    console.log('Building development copy');
  }
>>>>>>> 3effac8fc271f3f0020966e4f7a18f192426b187
